          ...
          <CardHeader
            ...
            avatar={
              <Avatar
                ...
                icon={<FontIcon className="material-icons">flag</FontIcon>}
              />
            }
            actAsExpander={true}
            showExpandableButton={true}
        ...
        >
          ...
          <CardText style={{marginLeft: '50px'}} expandable={true}>
            <p>
              ...
              quibusdam quam, porro in aperiam accusamus quaerat eum beatae
              atque rem omnis molestiae consequuntur sapiente pariatur
              cupiditate fuga nihil dolore? Voluptas.
